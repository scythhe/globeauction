...
export const dict: Record<string, Entry> = {
  ...
  "detail.maxBidExplainer": {
    ka: "მაქსიმალური თანხა, რომლის გადახდაც შეგიძლიათ — სისტემა ავტომატურად დადებს ბიდს თქვენს ნაცვლად, მხოლოდ საჭირო ოდენობით.",
    en: "The most you're willing to pay — we bid for you automatically, only as much as needed to stay ahead.",
    ru: "Максимальная сумма, которую вы готовы заплатить — мы делаем ставки за вас автоматически, только по мере необходимости.",
  },
  ...
  "detail.monsterBidExplainer": {
    ka: "გადადით პირდაპირ თანხაზე 100 ₾-იანი ნაბიჯებით — ჩვეულებრივი ნაბიჯების გვერდის ავლით.",
    en: "Jump straight to an amount in 100 ₾ steps — bypassing the ordinary increments.",
    ru: "Сразу перейдите к сумме шагами по 100 ₾ — в обход обычных шагов увеличения.",
  },
  "detail.monsterBidSubmit": { ka: "დადასტურება", en: "Confirm", ru: "Подтвердить" },
  "detail.preBidLabel": { ka: "წინასწარი ბიდი", en: "Pre-Bid", ru: "Предварительная ставка" },
  "detail.preBidExplainer": {
    ka: "აუქციონი ჯერ არ დაწყებულა — დააყენეთ მაქსიმალური თანხა ახლავე, დაწყებისთანავე ის ავტომატურად ჩაერთვება.",
    en: "Auction hasn't started — set your max bid now and it'll compete automatically once it goes live.",
    ru: "Аукцион ещё не начался — установите максимальную ставку сейчас, она вступит в силу автоматически при начале.",
  },
  "detail.preBidSubmit": { ka: "წინასწარი ბიდის დადება", en: "Place pre-bid", ru: "Сделать предварительную ставку" },
  "detail.startsAt": { ka: "იწყება: {date}", en: "Starts: {date}", ru: "Начало: {date}" },
  "detail.won": { ka: "მოიგეთ!", en: "Won!", ru: "Победа!" },
  "detail.bidPlaced": { ka: "ბიდი განთავსდა!", en: "Bid Placed!", ru: "Ставка сделана!" },
  ...
  "team.newListingTitle": { ka: "ახალი ლოტის შექმნა", en: "Create a new listing", ru: "Создать новый лот" },
  "team.ongoingTitle": { ka: "მიმდინარე მართვა", en: "Ongoing management", ru: "Текущее управление" },
  "team.step1Title": { ka: "ამ კვირის ავტომობილის დამატება", en: "Create this week's vehicle", ru: "Добавить автомобиль этой недели" },
  ...
  "team.step1bTitle": { ka: "ფოტოები", en: "Photos", ru: "Фотографии" },
  ...
  "team.coverPhoto": { ka: "მთავარი", en: "Cover", ru: "Обложка" },
  "team.makeCoverPhoto": { ka: "მთავარად დაყენება", en: "Set as cover", ru: "Сделать обложкой" },
  "team.step2Title": { ka: "აუქციონის შექმნა", en: "Create the auction", ru: "Создать аукцион" },
  "team.vehiclePickerPlaceholder": { ka: "აირჩიეთ ავტომობილი...", en: "Select a vehicle...", ru: "Выберите автомобиль..." },
  "team.vehicleJustCreated": { ka: "ახლახან შექმნილი", en: "Just created", ru: "Только что создан" },
  "team.noVehiclesAvailable": { ka: "აუქციონისთვის ხელმისაწვდომი ავტომობილი არ არის — ჯერ დაამატეთ ერთი ზემოთ.", en: "No vehicles available for auction — add one above first.", ru: "Нет доступных автомобилей для аукциона — сначала добавьте один выше." },
  ...
  "team.recordDeposit": { ka: "დეპოზიტის დაფიქსირება", en: "Record deposit", ru: "Зафиксировать депозит" },
  "team.depositAmountPlaceholder": { ka: "თანხა ₾", en: "Amount ₾", ru: "Сумма ₾" },
  "team.enterValidDeposit": { ka: "შეიყვანეთ სწორი თანხა", en: "Enter a valid amount", ru: "Введите корректную сумму" },
  "team.enableBidding": { ka: "ბიდინგის ჩართვა", en: "Enable bidding", ru: "Включить ставки" },

  "team.manageAuctionsTitle": { ka: "აუქციონების მართვა", en: "Manage auctions", ru: "Управление аукционами" },
  "team.noAuctionsYet": { ka: "აუქციონები ჯერ არ არის.", en: "No auctions yet.", ru: "Аукционов пока нет." },
  "team.reserveMet": { ka: "მინიმალური ფასი მიღწეულია", en: "Reserve met", ru: "Резерв достигнут" },
  "team.reserveNotMet": { ka: "მინიმალური ფასი არ არის მიღწეული", en: "Reserve not met", ru: "Резерв не достигнут" },
  "team.actionCancel": { ka: "გაუქმება", en: "Cancel", ru: "Отменить" },
  "team.confirmCancel": { ka: "გავაუქმოთ ეს აუქციონი?", en: "Cancel this auction?", ru: "Отменить этот аукцион?" },
  "team.actionVoidLastBid": { ka: "ბოლო ბიდის გაუქმება", en: "Void last bid", ru: "Аннулировать последнюю ставку" },
  "team.confirmVoidLastBid": { ka: "გავაუქმოთ ბოლო ბიდი?", en: "Void the last bid?", ru: "Аннулировать последнюю ставку?" },
  "team.actionAccept": { ka: "მიღება ამ ფასად", en: "Accept as-is", ru: "Принять как есть" },
  "team.actionDecline": { ka: "უარყოფა", en: "Decline", ru: "Отклонить" },
  "team.confirmDecline": { ka: "უარვყოთ ეს გაყიდვა?", en: "Decline this sale?", ru: "Отклонить эту продажу?" },
  "team.reassignPlaceholder": { ka: "მყიდველის User ID (ბიდების ისტორიიდან)", en: "Buyer's user ID (from bid history)", ru: "ID пользователя-покупателя (из истории ставок)" },
  "team.actionReassign": { ka: "გადანაწილება", en: "Reassign", ru: "Переназначить" },
  "team.actionViewHistory": { ka: "ისტორიის ნახვა", en: "View history", ru: "Показать историю" },
  "team.actionHideHistory": { ka: "ისტორიის დამალვა", en: "Hide history", ru: "Скрыть историю" },
  "team.historyEmpty": { ka: "ისტორია ცარიელია.", en: "No history yet.", ru: "История пуста." },
  "team.event.cancelled": { ka: "გაუქმდა", en: "cancelled", ru: "отменён" },
  "team.event.reassigned": { ka: "გადანაწილდა", en: "reassigned", ru: "переназначен" },
  ...
  "error.vehicle_has_no_photos": { ka: "აუქციონის შესაქმნელად საჭიროა მინიმუმ 1 ფოტო", en: "At least 1 photo is required to create an auction", ru: "Для создания аукциона нужна минимум 1 фотография" },
};
